...
# Requires both files AND the Vibey marker in CLAUDE.md
...
**Triggered when:** Framework already initialized (project-config.yaml and CLAUDE.md with Vibey marker exist)
