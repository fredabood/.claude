...
- ✅ `.vibey/` - Roadmap state directory (tracks, sprints, tasks)
- ✅ `.vibey/roadmap.yaml` - Project roadmap with sprint tracking
...
### .vibey/ Directory Structure

Roadmap state directory (created automatically during deployment):

```
.vibey/
├── roadmap.yaml              # Main roadmap file with project metadata
├── ai-reference.md           # Quick reference for AI assistants
├── tracks/                   # Track definitions
│   └── main.yaml            # Main development track
├── sprints/                  # Sprint state files
│   └── main-1.yaml          # Sprint 1 metadata and progress
├── tasks/                    # Task state files
│   └── main-1-tasks.yaml    # Tasks for Sprint 1
├── sprint_docs/              # Sprint documentation
└── sprint_summaries/         # Completed sprint summaries
```

**Purpose:** The roadmap system tracks your project's development across multiple sprints:
- **Tracks:** Organize work into parallel development streams
- **Sprints:** Time-boxed development cycles with goals and deliverables
- **Tasks:** Individual work items extracted from sprint plans
- **Progress tracking:** Automatic status updates as you work
- **Dependencies:** Track blockers and prerequisites between tasks/sprints
- **Quality gates:** Ensure standards are met before completion
...
# Show sprint details
python3 .claude/scripts/roadmap show main-1

# List tasks
python3 .claude/scripts/roadmap list tasks

# Start a task
python3 .claude/scripts/roadmap start main-1-task-001
```
