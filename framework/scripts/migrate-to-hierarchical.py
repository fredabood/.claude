...
This is Task 005 of documentation-system Sprint 1.

Usage:
    python3 framework/scripts/migrate-to-hierarchical.py             # Dry run
    python3 framework/scripts/migrate-to-hierarchical.py --execute   # Migrate
"""
...
class HierarchicalMigrator:
    ...
    def run(self, dry_run: bool = True) -> bool:
        ...
        sprint_map = {}  # sprint_id -> (track_slug, sprint_slug)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Migrate from flat to hierarchical structure',
