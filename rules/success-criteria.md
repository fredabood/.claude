...
2. If the user agrees, draft criteria based on the description and post as a Plane comment (or suggest editing the description).
...
3. Post a verification report to Plane as a comment
