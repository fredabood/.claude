...
def list_platforms() -> None:
    """
    List available platforms with rich table output.

    Displays a formatted table showing all registered platforms,
    their status, and adapter class names.
    """
...
def get_available_platforms() -> List[str]:
    ...
    Returns:
        List of platform names (e.g., ["claude-code", "goose"])
    """
...
def is_platform_available(platform: str) -> bool:
    """
    Check if a platform is available for deployment.
