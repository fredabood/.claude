...
Provides pre-commit, commit-msg, pre-push, post-merge, and post-checkout hooks
for validating and syncing Git operations with roadmap integration.

Tasks: git-integration-2-task-001, git-integration-2-task-002, sqlite-backend-3-task-003, sqlite-backend-3-task-004, git-integration-5-task-006
"""
